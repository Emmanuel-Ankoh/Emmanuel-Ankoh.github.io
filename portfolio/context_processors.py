...
def site_settings(request):
    ...
    try:
        ...
        obj = None
    if obj:
        # Normalize hero fields so templates don't need non-standard filters
        def _norm_text(v):
            try:
                if not v:
                    return None
        ...
        hero_h = _norm_text(getattr(obj, 'hero_heading', None))
        hero_s = _norm_text(getattr(obj, 'hero_subheading', None))
